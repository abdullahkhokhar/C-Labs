    ...
    while (1) {
        ...
        while ((nbytes = read(fd, after, room)) > 0) {
            ...
            while ((where = find_network_newline(buf, inbuf)) > 0) {
                ...
                // ----- I will replace "\r\n" with the '\0'
                // where is 1 + index of network new line
                buf[where-2] = '\0';
                ...
                inbuf = inbuf-where; // all the remaining # of items after the \r\n
                ...
                // buf is where we want to store, and we whatever is after where.
